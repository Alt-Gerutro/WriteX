<p align="center">
  ...
  <img src="https://img.shields.io/badge/Project Version-0.3.2-white">
</p>
...
Добавьте файлы `writex.cpp` и `writex.hpp`.  
Для сборки используйте скрипты или добавляйте ключ `-DCMAKE_CXX_COMPILER=clang++` (на остальных компиляторах проверено не было).  
